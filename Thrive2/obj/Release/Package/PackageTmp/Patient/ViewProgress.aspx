<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewProgress.aspx.cs" Inherits="Thrive2.Patient.ViewProgress" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="wrapper">
            ...
            <div id="sidebar">
                ...
                <div id="menu" class="menu-v">
                    ...
                    <ul>
                        ...
                        <li><a href="ViewProgress.aspx" class="active">My Progress</a></li>
            ...
            <div id="content">
                <div class="line"></div>                                
                <asp:Image runat="server" ID="img1" ImageUrl="../images/PC_M1.jpg" />
                <asp:Image runat="server" ID="img2" ImageUrl="../images/PC_M2.jpg" />
